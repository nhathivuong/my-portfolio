...
const NyanCat = () =>{
    return (
        <div className="text-center xl:text-white flex justify-center sm:justify-between justify-self-center items-center flex-col sm:flex-row sm:flex-wrap gap-4 w-fit m-5 p-2 xl:drop-shadow-[1px_1px_1px_black] hover:bg-slate-900 rounded-sm">
            <div>
                <h2 className="text-xl sm:text-3xl font-mont font-bold p-2">Nyan Cat</h2>
                <img className="border-2 xl:w-[15vw] justify-self-center ring-2 inset-ring border-y-3 border-black" src="/assets/portfolio/NyanCat.gif" alt="a space invader inspired game"/>
            </div>
